...
// Component to display checked items
const DisplayCheckedItems = ({ checkedItems }) => {
  return (
...
function fw() {
  ...
  useEffect(() => {
    const amount = checkedItems.reduce((acc, item) => acc + item.price, 0);
  ...
  return (
    <section className="">
      <Link href="/vehicleservices" className="mt-2 mb-4">
            <img
      ...
      <div class="lg:container lg:mx-auto grid grid-cols-9 lg:grid-cols-12">
        <div class="col-span-9 lg:col-span-8 xl:col-span-9 bg-white dark:bg-gray-900 h-[160vh]  relative lg:px-10 p-6 lg:py-12">
          ...
          <div class="mt-5 lg:mt-20">
            <h3 class=" text-gray-800 dark:text-gray-50 font-medium text-xl">Select Services</h3>
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                     Four Wheeler repair (+ Extra depend on Service)
                    </p>
                  </label>
                </div>
                {/* //item end */}
          ...
          <div class="mt-7 lg:mt-20">
            <p class=" text-gray-600 font-medium text-xl dark:text-white mb-3">Your details</p>
        ...
        <div class="relative col-span-9 lg:col-span-4 xl:col-span-3 bg-gray-100 dark:bg-gray-800 lg:h-auto xl:h-screen px-8 py-14 xl:px-12 xl:py-20">
          ...
          <div class="flex flex-1 ">
            <h3 class="text-gray-800 dark:text-gray-50 font-semibold text-2xl mt-[-2rem]">
              Services
            </h3>
            <div class="flex-auto"></div>
          </div>

          <div class="mt-2 text-gray-800 space-y-60 dark:text-gray-50 text-lg font-normal">
            <DisplayCheckedItems checkedItems={checkedItems} />
          ...
          <div className="mt-10">
          <Link href="" class=" bg-black hover:bg-gray-800 dark:bg-gray-200 rounded-md dark:hover:bg-gray-300 dark:text-gray-900 text-white p-3 text-lg  w-full md:w-auto">
            Confirm
          </Link>
          </div>
        </div>
