          ...
          <li key={index} className="flex justify-center items-center space-x-2">
            <span className="flex justify-between items-center ">
              <span className="text-sm w-[6rem] px-2">{item.name}</span>{" "}
                ...
                />
            </span> <p className="text-sm">Sqft</p>
  ...
  return (
    <section className="">
      <Link href="/construction" className="mt-2 mb-4">
        ...
        />
        <img
          className="inline dark:block "
          src="https://tuk-cdn.s3.amazonaws.com/can-uploader/checkouts-3-svg1dark.svg"
          alt="back"
        />
        <span className="cursor-pointer text-gray-500  dark:text-white font-normal text-base  dark:hover:text-white">
          Back
        </span>
      </Link>
      <div className="lg:container lg:mx-auto grid grid-cols-9 lg:grid-cols-12">
        <div className="col-span-9 lg:col-span-8 xl:col-span-9 bg-white dark:bg-gray-900 h-[160vh]  relative lg:px-10 p-6 lg:py-12">
          <h3 className="font-semibold text-gray-800 dark:text-gray-50 text-4xl mt-4">
            Architecture
          </h3>

          <div className="mt-5 lg:mt-20">
            <h3 className=" text-gray-800 dark:text-gray-50 font-medium text-xl">
              Select Services
            </h3>
              ...
              <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
                ...
                >
                  ...
                  >
                    ...
                    <p className="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Structural plans ₹ 10/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p className="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      3D plan ₹ 5000/1 view (Depending on square feet also)
                    </p>
                  </label>
                </div>
                {/* //item end */}
          ...
          <div className="mt-7 lg:mt-20">
            <p className=" text-gray-600 font-medium text-xl dark:text-white mb-3">
              Your details
            </p>
            ...
            <form className="mt-8" action="" autocomplete="off">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                <input
                  aria-label="yourName"
                  className="border-b-2 items-center p-4 border-gray-300 pb-3 text-base text-gray-600 font-normal placeholder-gray-600 focus:outline-none"
                  type="text"
                  name="yourName"
                  id="YourName"
        ...
        <div className="relative col-span-9 lg:col-span-4 xl:col-span-3 bg-gray-100 dark:bg-gray-800 lg:h-auto xl:h-screen px-8 py-14 xl:px-12 xl:py-20">
          <div>
            <div className=" text-center ">
              <h3 className="text-gray-800 dark:text-gray-50 font-semibold text-2xl mt-[-2rem] text-center ">
                Services
              </h3>
            </div>

            <div className="mt-2 text-gray-800 space-y-60 dark:text-gray-50 text-lg font-normal w-[18rem] ml-[-2rem]">
              <DisplayCheckedItems
                checkedItems={checkedItems}
                updateQuantity={updateQuantity}
              />
              <h3 className="text-right pr-4 md:pr-5 lg:pr-4"></h3>
              <div className="mt-4">
          ...
          <div className="mt-10">
            <Link
              href=""
              className=" bg-black hover:bg-gray-800 dark:bg-gray-200 rounded-md dark:hover:bg-gray-300 dark:text-gray-900 text-white p-3 text-lg  w-full md:w-auto"
            >
              Confirm
            </Link>
          </div>
