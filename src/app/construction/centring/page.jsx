  ...
  return (
    <section className="">
      ...
      <div class="lg:container lg:mx-auto grid grid-cols-9 lg:grid-cols-12">
        <div class="col-span-9 lg:col-span-8 xl:col-span-9 bg-white dark:bg-gray-900 h-[170vh]  relative lg:px-10 p-6 lg:py-12">
              ...
              <nav class="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Foundation & steel  ₹ 35/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Plinth Beam  ₹ 20/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Column & Steel  ₹ 20/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Lintal Beam  ₹ 20/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Slab casting ₹ 65/sqft (Depending on square feet)
                    </p>
                  </label>
                </div>
                {/* //item end */}
