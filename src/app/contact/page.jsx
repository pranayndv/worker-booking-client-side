    ...
    <section className="text-center mt-6">
      <div class="max-w-6xl mx-auto bg-white my-6 font-[sans-serif] text-[#011c2b]">
        <div class="text-center px-6">
          <h2 class="text-[2.25rem] font-bold">Contact Us</h2>
          <p class="text-sm text-gray-500 mt-3">
          Have some doubts? Feel free to ask!
          </p>
        </div>
        <div class="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
          <div class="bg-[url('/img/background.jpg')] bg-cover opacity-[95] bg-no-repeat rounded-lg p-6 max-lg:text-center">
            ...
            <ul class="mt-16 space-y-10">
              ...
              <li class="flex items-center max-lg:justify-center">
                ...
                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                  <strong>Deoolwadi, Sindhudurg</strong>
                </a>
              </li>
            </ul>
          ...
          <div class="p-6 rounded-xl lg:col-span-2">
            <form>
              ...
              <button
                type="button"
                class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-black text-white hover:bg-[#011c2bf3]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
