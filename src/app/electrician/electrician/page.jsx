...
const electrician = () => {
  ...
  return (
    <section className="">
      <Link href="/electrician" className="mt-2 mb-4">
        <img
              ...
              <nav class="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Consile fitting ₹ 300/Point (Depending on Points)
                    </p>
                  </label>
                </div>
                {/* //item end */}
                ...
                >
                  ...
                  >
                    ...
                    <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
                      Strip Fitting ₹ 150/Point (Depending on Points)
                    </p>
                  </label>
                </div>
                {/* //item end */}
